...
): { title: string; dueDate: string | null; reminderAt: string | null } {
...
function parseChineseQuickTime(
...
): { title: string; dueDate: string | null; reminderAt: string | null } | null {
  const datePrefix =
  ...
  const match = raw.match(new RegExp(`^\\s*${datePrefix}${timePrefix}${timeCore}`));
